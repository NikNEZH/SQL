CREATE DATABASE IF NOT EXISTS home_4_plus;
USE home_4_plus;
...
SELECT COLOR, count(*) as count FROM AUTO WHERE MARK = 'BMW' GROUP BY COLOR;

SELECT COLOR, count(*) as count FROM AUTO WHERE MARK = 'LADA' GROUP BY COLOR;

SELECT a1.MARK, count(*) as count
FROM AUTO a1
LEFT JOIN AUTO a2 ON a1.MARK != a2.MARK
GROUP BY a1.MARK;